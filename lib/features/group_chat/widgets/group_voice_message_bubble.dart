...
class GroupVoiceMessageBubbleWidget extends StatefulWidget {
  ...
  State<GroupVoiceMessageBubbleWidget> createState() =>
      _GroupVoiceMessageBubbleWidgetState();
}
...
class _GroupVoiceMessageBubbleWidgetState
  ...
  bool get _isLocalFile => widget.voiceUrl.startsWith('/');
  ...
  @override
  void didUpdateWidget(GroupVoiceMessageBubbleWidget oldWidget) {
  ...
  Future<void> _initAndPlay() async {
    if (widget.voiceUrl.isEmpty || widget.isUploading) return;
