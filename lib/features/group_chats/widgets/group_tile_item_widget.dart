...
import '../cubit/group_selection_cubit/group_selection_cubit.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<GroupSelectionCubit, GroupSelectionState>(
      builder: (context, selection) {
        ...
        final isSelected = selection.isSelected(group.id);
        ...
        return Material(
          ...
          child: ListTile(
            ...
            onLongPress:
                () => context.read<GroupSelectionCubit>().toggle(group.id),
            onTap: () {
              if (isSelecting) {
                context.read<GroupSelectionCubit>().toggle(group.id);
                return;
